...
<YouTubeEmbed id="IaZZVRd_WeU" title="Prelude to Tristan und Isolde" composer="Richard Wagner" />
<YouTubeEmbed id="XoBo8dlPcQo" title="Der Erlkönig" composer="Franz Schubert" />
<YouTubeEmbed id="IoENgt1h4_A" title="La Mer: 'From Dawn to Noon on the Sea'" composer="Claude Debussy" />
