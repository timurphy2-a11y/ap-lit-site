...
<MusicPlate title="Ave Maria...virgo serena" composer="Josquin des Prez" date="c. 1485" youtube_id="s-pVbpV4yuk" note={"Renaissance polyphony\n4-voice motet\nTextbook imitative counterpoint"} />
...
<MusicPlate title="Spem in Alium" composer="Thomas Tallis" date="c. 1570" youtube_id="CkL1hdL40i0" note={"40-voice motet\nRenaissance polyphony at its most complex\nEach voice independent"} />
